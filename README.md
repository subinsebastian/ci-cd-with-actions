[![React App CI](https://github.com/subinsebastian/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/subinsebastian/ci-cd-with-actions/actions/workflows/ci.yml)
